...
public class AltaEmpleado implements ActionListener, WindowListener
{
	...
	TextField txtCargoEmpleado = new TextField(20);
	...
	public AltaEmpleado()
	{
		...
		frmAltaEmpleado.add(lblCargoEmpleado);
		txtApellidosEmpleado.setText("");
		frmAltaEmpleado.add(txtCargoEmpleado);
		...
		frmAltaEmpleado.setSize(250,140);
